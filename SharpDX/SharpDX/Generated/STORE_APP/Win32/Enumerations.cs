...
namespace SharpDX.Win32
{
    ...
    /// <summary>
    /// <p> The 
    /// <strong><see cref = "SharpDX.Win32.CommitFlags"/></strong> enumeration constants specify the conditions for performing the commit operation in the 
    /// <strong>IStorage::Commit</strong> and 
    /// <strong>IStream::Commit</strong> methods.</p>
    /// </summary>
    /// <remarks>
    /// <p>You can specify <strong>STGC_DEFAULT</strong> or some combination of <strong>STGC_OVERWRITE</strong>, <strong>STGC_ONLYIFCURRENT</strong>, and <strong>STGC_DANGEROUSLYCOMMITMERELYTODISKCACHE</strong> for normal commit operations. You can specify <strong>STGC_CONSOLIDATE</strong> with any other <see cref = "SharpDX.Win32.CommitFlags"/> flags.</p><p>Typically, use <strong>STGC_ONLYIFCURRENT</strong> to protect the storage object in cases where more than one user can edit the object simultaneously.</p>
    /// </remarks>
    /// <doc-id>aa380320</doc-id>
    ...
    public enum ErrorCode : System.Int32
    {
        /// <summary>
        /// No documentation.
        /// </summary>
    ...
    /// <summary>
    /// <p> The 
    /// <strong><see cref = "SharpDX.Win32.LockType"/></strong> enumeration values indicate the type of locking requested for the specified range of bytes. The values are used in the 
    /// <strong>ILockBytes::LockRegion</strong> and 
    /// <strong>IStream::LockRegion</strong> methods.</p>
    /// </summary>
    /// <doc-id>aa380048</doc-id>
    ...
    /// <summary>
    /// <p> The 
    /// <strong><see cref = "SharpDX.Win32.StorageStatisticsFlags"/></strong> enumeration values indicate whether the method should try to return a name in the <strong>pwcsName</strong> member of the 
    /// <strong><see cref = "SharpDX.Win32.StorageStatistics"/></strong> structure. The values are used in the 
    /// <strong>ILockBytes::Stat</strong>, 
    /// <strong>IStorage::Stat</strong>, and 
    /// <strong>IStream::Stat</strong> methods to save memory when the <strong>pwcsName</strong> member is not required.</p>
    /// </summary>
    /// <doc-id>aa380316</doc-id>
